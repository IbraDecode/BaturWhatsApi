...
| # | Task | Status |
|---|------|--------|
| T-101 | Signal e2e crypto engine: identity keys, prekeys, X3DH/Double Ratchet (own implementation; stdlib crypto) | TODO |
| T-102 | `api.SendText` / media-free message send over real flow | TODO |
| T-103 | Registration & QR/pairing-code flow (companion platform) | TODO |
| T-104 | Sync engine: contacts, chats, history, appstate + checkpoints | TODO |
